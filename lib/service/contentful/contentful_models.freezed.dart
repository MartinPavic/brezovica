...
Entry<T> _$EntryFromJson<T>(Map<String, dynamic> json) {
  return _Entry<T>.fromJson(json);
}
...
class _$EntryTearOff {
  ...
  _Entry<T> call<T>({required T fields, required Sys sys, Object? metadata}) {
    return _Entry<T>(
      fields: fields,
      sys: sys,
      metadata: metadata,
  ...
  Entry<T> fromJson<T>(Map<String, Object?> json) {
    return Entry<T>.fromJson(json);
  }
}
...
abstract class $EntryCopyWith<T, $Res> {
  ...
  $Res call({T fields, Sys sys, Object? metadata});
...
class _$_Entry<T> implements _Entry<T> {
  const _$_Entry({required this.fields, required this.sys, this.metadata});
  ...
  @override
  String toString() {
    return 'Entry<$T>(fields: $fields, sys: $sys, metadata: $metadata)';
  }
...
abstract class _Entry<T> implements Entry<T> {
  const factory _Entry(
      {required T fields, required Sys sys, Object? metadata}) = _$_Entry<T>;

  factory _Entry.fromJson(Map<String, dynamic> json) = _$_Entry<T>.fromJson;
...
Collection<T> _$CollectionFromJson<T>(Map<String, dynamic> json) {
  return _Collection<T>.fromJson(json);
}
...
class _$CollectionTearOff {
  ...
  Collection<T> fromJson<T>(Map<String, Object?> json) {
    return Collection<T>.fromJson(json);
  }
}
...
/// @nodoc
abstract class _$CollectionCopyWith<T, $Res>
    implements $CollectionCopyWith<T, $Res> {
  factory _$CollectionCopyWith(
          _Collection<T> value, $Res Function(_Collection<T>) then) =
      __$CollectionCopyWithImpl<T, $Res>;
  @override
  $Res call(
      {Sys sys,
      int total,
...
/// @nodoc
class __$CollectionCopyWithImpl<T, $Res>
    extends _$CollectionCopyWithImpl<T, $Res>
    implements _$CollectionCopyWith<T, $Res> {
  __$CollectionCopyWithImpl(
      _Collection<T> _value, $Res Function(_Collection<T>) _then)
      : super(_value, (v) => _then(v as _Collection<T>));

  @override
  _Collection<T> get _value => super._value as _Collection<T>;
...
class _$_Collection<T> implements _Collection<T> {
  ...
  @override
  String toString() {
    return 'Collection<$T>(sys: $sys, total: $total, skip: $skip, limit: $limit, items: $items, includes: $includes)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  _$CollectionCopyWith<T, _Collection<T>> get copyWith =>
      __$CollectionCopyWithImpl<T, _Collection<T>>(this, _$identity);
...
abstract class _Collection<T> implements Collection<T> {
  const factory _Collection(
      ...
      required int limit,
      required List<T> items,
      Includes? includes}) = _$_Collection<T>;

  factory _Collection.fromJson(Map<String, dynamic> json) =
      _$_Collection<T>.fromJson;
